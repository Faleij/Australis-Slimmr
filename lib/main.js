...
function contentMouseout(e){
	console.log("contentMouseout",e);
	if(!inFocus && e.clientY < 65)
...
function initializeWindow(window){
    ...
    if(chromeWindow){
        ...
        addListeners(window, chromeWindow.document.querySelectorAll("#navigator-toolbox textbox"), listenerMap);
        addListeners(window, chromeWindow.document.querySelectorAll("#navigator-toolbox searchbar"), listenerMap);   
		addListeners(window, chromeWindow.document.querySelectorAll("#browser-panel>#content-deck"), 
